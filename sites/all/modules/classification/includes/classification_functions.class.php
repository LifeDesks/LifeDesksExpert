...
/**
 * Designed by Patrick Leary, Encyclopedia of Life
...
class Names
{
    public static function canonical_form($string)
    {
        ...
        $sci_parts = self::sci_parts();
        $author_parts = self::author_parts();
        $junk_parts = self::junk_parts();
        for($i=1 ; $i<$num ; $i++)
        {
            ...
            if(@$sci_parts[$words[$i]] || @$author_parts[$words[$i]] || @$junk_parts[$words[$i]]) continue;
    ...
    {
        $canonicalForm = self::canonical_form($string);
        
        $words = explode(" ",$canonicalForm);
