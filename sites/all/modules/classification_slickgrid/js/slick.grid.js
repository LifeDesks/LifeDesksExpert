...
/*****************************
Added by D. P. Shorthouse
******************************/
	                m.formatter = (typeof m.formatter == 'function') ? m.formatter : window[m.formatter];
/*****************************/
...
/**********************************
edited by D. P. Shorthouse
**********************************/
            editor = window[columns[currentCell].editor];
            currentEditor = new editor($(currentCellNode), columns[currentCell], value, data[currentRow]);
/*********************************/
        };
...
Edited by D. P. Shorthouse
**********************************/
                                ValueHandler = window[columns[currentCell].setValueHandler];
                                ValueHandler(value, columns[currentCell], data[currentRow]);
/*********************************/
                            }
                            else {
/********************************
Added by D. P. Shorthouse
/*******************************/
                                if(columns[currentCell].setDataHandler) {
                                  DataHandler = window[columns[currentCell].setDataHandler];
                                  DataHandler(value,columns[currentCell], data[currentRow], currentEditor.getAdditionalData());
                                }
/********************************/
